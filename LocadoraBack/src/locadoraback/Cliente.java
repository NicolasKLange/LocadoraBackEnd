...
public class Cliente {
    ...
    public boolean incluirCliente() throws ClassNotFoundException{
        ...
        try {
            ...
            System.out.println("Inclusao do cliente com problema" + error);
            return false;
        }
        return true;
    }
    
    ///CLASSE PARA ALTERAR O CLIENTE OK!
    public boolean alterarCliente() throws ClassNotFoundException{
     ...
     ///CLASSE PARA EXCLUIR O CLIENTE OK!
     public boolean excluirCliente() throws ClassNotFoundException{
        ...
        try {
            ...
            System.out.println("Exclusao do cliente com problema " + error);
            return false;
        }
        return true;
    }
    
    ///CLASSE PARA CONSULTAR O CLIENTE OK!
    public Cliente consultarCliente() throws ClassNotFoundException{
        String sql = "select nomecliente,email,fonecel ";
               sql+= "from cliente ";
               sql+= "where codcliente = ?";
        Connection con = Conexao.conectar();
        Cliente cli = null;
    ...
    ///CLASSE PARA CONSULTAR TODOS OS CLIENTES OK!
    public List<Cliente> consultarClienteS() throws ClassNotFoundException{
        String sql = "select codcliente,nomecliente,email,fonecel ";
               sql+= "from cliente ";
               sql+= "order by 2 desc";
        Connection con = Conexao.conectar();
    ...
    ///CLASSE PARA REAJUSTAR SALARIO CLIENTE OK!
